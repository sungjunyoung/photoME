...
public class SignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View1.setTypeface(createFromAsset(getAssets(), "saymael.ttf"));
        Pw.setTypeface(createFromAsset(getAssets(), "saymael.ttf"));
        confirmPw.setTypeface(createFromAsset(getAssets(), "saymael.ttf"));
    ...
    public void checkPwconfirmPw() {
        if (Pw.getText().toString().equals(confirmPw.getText().toString())) {
            ...
            Toast.makeText(SignupActivity.this, "입력한 비밀번호가 일치하지 않습니다", Toast.LENGTH_SHORT).show();
        }
    }
